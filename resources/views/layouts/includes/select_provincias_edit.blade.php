<option value="Maputo" @if ($var == 'Maputo') selected @else @endif>Maputo</option>
<option value="Gaza" @if ($var == 'Gaza') selected @else @endif>Gaza</option>
<option value="Inhambane" @if ($var == 'Inhambane') selected @else @endif>Inhambane</option>
<option value="Sofala" @if ($var == 'Sofala') selected @else @endif>Sofala</option>
<option value="Manica" @if ($var == 'Manica') selected @else @endif>Manica</option>
